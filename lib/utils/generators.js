...
exports.isMyTurnToAct = isMyTurnToAct;
...
function generateTrumpSuitTextSprite(trumpSuit) {
  const trumpSuitString = trumpSuit ? _Constants.Constants.gameConstants.MAP_ABBREVIATION_TO_SUITS[trumpSuit] : 'None';
