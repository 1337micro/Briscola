...
class Game {
  constructor(gameState = {}) {
    ...
    this.trumpCard = gameState.trumpCard === null ? null : new _Card.Card(gameState.trumpCard);
  ...
  init() {
    ...
    this.deck.shuffle();
    const hand1 = new _Hand.Hand({
      gameType: this.gameType
    });
    this.isBriscola500() ? hand1.addCards([this.deck.drawCard(), this.deck.drawCard(), this.deck.drawCard(), this.deck.drawCard(), this.deck.drawCard()]) : hand1.addCards([this.deck.drawCard(), this.deck.drawCard(), this.deck.drawCard()]);
    const hand2 = new _Hand.Hand({
      gameType: this.gameType
    });
    this.isBriscola500() ? hand2.addCards([this.deck.drawCard(), this.deck.drawCard(), this.deck.drawCard(), this.deck.drawCard(), this.deck.drawCard()]) : hand2.addCards([this.deck.drawCard(), this.deck.drawCard(), this.deck.drawCard()]);
  ...
  isBriscola500() {
    return this.gameType === _Constants.Constants.gameConstants.BRSICOLA_500;
  }
  ...
  getWinningPlayerIndex(trumpSuit) {
    return (this.firstPlayerToActByIndex + this.middlePile.decideWinningCardIndex(trumpSuit)) % _Constants.Constants.gameConstants.NUMBER_OF_PLAYERS;
  }
  /**
   * winning for the particular round
   */
